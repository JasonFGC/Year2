 ...
 * CSI 2110
 *
 * DBScan is the main class of the program. Here, you can
 * read in a set of 3D Points with read(), sort them into clusters
 * with findclusters(), and output the clustered points (with unique 
 * rgb values for each cluster) using save().
 *
 * @author Kyle Sprague
 */
